const app = {
  ...
  displayAccountTitle: process.env.DISPLAY_ACCOUNT_TITLE ?? false,
  disableTelegramMessages: process.env.DISABLE_TELEGRAM_MESSAGES ?? false,
  ...
  drops: [
    {
      ...
      enabled: process.env.FARMER_DIGGER_ENABLED ?? true,
    ...
    },
    {
      id: "frogster",
      title: "🐸 Frogster",
      enabled: process.env.FARMER_FROGSTER_ENABLED ?? true,
    ...
    },
    {
      ...
      enabled: process.env.FARMER_META_LOTT_ENABLED ?? true,
    ...
    },
    {
      ...
      enabled: process.env.FARMER_BATTLE_BULLS_ENABLED ?? true,
    ...
    },
    {
      ...
      enabled: process.env.FARMER_GOLD_EAGLE_ENABLED ?? true,
    ...
    },
    {
      id: "hrum",
      title: "🥠 Hrum Farmer",
      enabled: process.env.FARMER_HRUM_ENABLED ?? true,
    ...
    },
    {
      ...
      enabled: process.env.FARMER_SPACE_ADVENTURE_ENABLED ?? true,
    ...
    },
    {
      id: "wonton",
      title: "👨‍🍳 Wonton Farmer",
      enabled: process.env.FARMER_WONTON_ENABLED ?? true,
    ...
    },
    {
      ...
      enabled: process.env.FARMER_FUNATIC_ENABLED ?? true,
    ...
    },
    {
      ...
      enabled: process.env.FARMER_SLOTCOIN_ENABLED ?? true,
    ...
    },
    {
      ...
      enabled: process.env.FARMER_DREAMCOIN_ENABLED ?? true,
