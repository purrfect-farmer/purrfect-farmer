...
export const createLocationHash = (chatId, type, threadId) => {
...
export function parseLocationHash(currentUserId) {
...
export const createMessageHashUrl = (chatId, type, threadId) => {
