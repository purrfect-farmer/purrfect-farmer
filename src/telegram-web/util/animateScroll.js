...
import { SCROLL_MAX_DISTANCE, SCROLL_MAX_DURATION, SCROLL_MIN_DURATION, SCROLL_SHORT_TRANSITION_MAX_DISTANCE, } from '../config';
...
export default function animateScroll(args) {
    currentArgs = args;
...
function createMutateFunction(args) {
    ...
    return () => {
        ...
        const duration = forceDuration || (SCROLL_MIN_DURATION
...
function calculateScrollFrom(container, scrollTo, maxDistance = SCROLL_MAX_DISTANCE, forceDirection) {
