...
export async function fetch(cacheName, key, type, isHtmlAllowed = false) {
    if (!cacheApi) {
        return undefined;
    }
    try {
...
export async function save(cacheName, key, data) {
    if (!cacheApi) {
        return false;
    }
    try {
...
export async function remove(cacheName, key) {
    try {
        if (!cacheApi) {
            return undefined;
        }
...
export async function clear(cacheName) {
    try {
        if (!cacheApi) {
            return undefined;
        }
