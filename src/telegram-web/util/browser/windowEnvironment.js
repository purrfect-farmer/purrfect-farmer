...
/**
 * Original Code: export const IS_ELECTRON = Boolean(window.electron);
 */
...
export const IS_SERVICE_WORKER_SUPPORTED = false; // Disable Service Worker
...
const hasBrokenServiceWorkerStreaming =
  chromeVersion && Number(chromeVersion) === 132;
// TODO Consider failed service worker
export const IS_PROGRESSIVE_SUPPORTED =
  IS_SERVICE_WORKER_SUPPORTED && !hasBrokenServiceWorkerStreaming;
