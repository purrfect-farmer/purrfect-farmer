export const CUSTOM_PEER_PREMIUM = {
    isCustomPeer: true,
    type: 'premium',
...
export const CUSTOM_PEER_INCLUDED_CHAT_TYPES = [
    {
        isCustomPeer: true,
        type: 'contacts',
...
export const CUSTOM_PEER_EXCLUDED_CHAT_TYPES = [
    {
        isCustomPeer: true,
        type: 'excludeMuted',
...
export const CUSTOM_PEER_HIDDEN = {
    isCustomPeer: true,
    type: 'hidden',
