 ...
 * @param checkHash
 */
export function getInputPeer(entity, allowSelf = true, checkHash = true) {
 ...
 * @returns {Number}
 */
export function getDownloadPartSize(fileSize) {
 ...
 * @returns {Number}
 */
export function getUploadPartSize(fileSize) {
    if (fileSize <= 104857600) { // 100MB
        return 128;
    }
    if (fileSize <= 786432000) { // 750MB
 ...
 */
export function getDC(dcId, downloadDC = false) {
