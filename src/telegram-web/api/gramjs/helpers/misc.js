...
import { DAY, getDays, getHours, getMinutes, HOUR, MINUTE, } from '../../../util/dates/units';
...
export function resolveMessageApiChatId(mtpMessage) {
...
export function isChatFolder(filter) {
...
export function deserializeBytes(value) {
    return Buffer.from(value, 'binary');
}
export function log(suffix, ...data) {
...
export function isResponseUpdate(result) {
