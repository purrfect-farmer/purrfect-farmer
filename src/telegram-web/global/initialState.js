...
import { ANIMATION_LEVEL_DEFAULT, DARK_THEME_PATTERN_COLOR, DEFAULT_GIFT_PROFILE_FILTER_OPTIONS, DEFAULT_MESSAGE_TEXT_SIZE_PX, DEFAULT_PATTERN_COLOR, DEFAULT_PLAYBACK_RATE, DEFAULT_RESALE_GIFTS_FILTER_OPTIONS, DEFAULT_VOLUME, IOS_DEFAULT_MESSAGE_TEXT_SIZE_PX, MACOS_DEFAULT_MESSAGE_TEXT_SIZE_PX, } from '../config';
import { IS_IOS, IS_MAC_OS } from '../util/browser/windowEnvironment';
export const INITIAL_PERFORMANCE_STATE_MAX = {
    animatedEmoji: true,
    autoplayGifs: true,
    autoplayVideos: true,
...
export const INITIAL_PERFORMANCE_STATE_MID = {
    animatedEmoji: true,
    autoplayGifs: true,
    autoplayVideos: true,
    contextMenuAnimations: true,
...
export const INITIAL_PERFORMANCE_STATE_MIN = {
    animatedEmoji: false,
    autoplayGifs: false,
...
export const INITIAL_SHARED_STATE = {
    settings: {
        theme: 'light',
