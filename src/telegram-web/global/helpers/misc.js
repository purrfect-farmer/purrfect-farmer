...
export function buildApiInputPrivacyRules(global, { visibility, isUnspecified, allowedIds, blockedIds, shouldAllowPremium, botsPrivacy, }) {
    const { users: { byId: usersById }, chats: { byId: chatsById }, } = global;
