...
import { ANIMATION_WAVE_MIN_INTERVAL, DEBUG, GLOBAL_STATE_CACHE_CUSTOM_EMOJI_LIMIT, INACTIVE_MARKER, PAGE_TITLE, } from '../../../config';
...
import { selectCanAnimateInterface, selectChat, selectChatFullInfo, selectChatMessage, selectCurrentChat, selectCurrentMessageList, selectIsChatWithBot, selectIsChatWithSelf, selectIsCurrentUserPremium, selectIsTrustedBot, selectPeerPaidMessagesStars, selectSender, selectTabState, selectTopic, } from '../../selectors';
import { selectSharedSettings } from '../../selectors/sharedState';
import { getIsMobile, getIsTablet } from '../../../hooks/useAppLayout';
export const APP_VERSION_URL = 'version.txt';
const FLOOD_PREMIUM_WAIT_NOTIFICATION_DURATION = 6000;
const MAX_STORED_EMOJIS = 8 * 4; // Represents four rows of recent emojis
addActionHandler('toggleChatInfo', (global, actions, payload) => {
...
addActionHandler('toggleManagement', (global, actions, payload) => {
    const { force, tabId = getCurrentTabId() } = payload || {};
...
addActionHandler('closeManagement', (global, actions, payload) => {
...
addActionHandler('processOpenChatOrThread', (global, actions, payload) => {
    const { tabId = getCurrentTabId() } = payload;
...
addActionHandler('resetNextProfileTab', (global, actions, payload) => {
    const { tabId = getCurrentTabId() } = payload || {};
    const { chatId } = selectCurrentMessageList(global, tabId) || {};
    if (!chatId) {
        return undefined;
...
addActionHandler('toggleStatistics', (global, actions, payload) => {
    const { tabId = getCurrentTabId() } = payload || {};
    const tabState = selectTabState(global, tabId);
    return updateTabState(global, {
...
addActionHandler('toggleMessageStatistics', (global, actions, payload) => {
...
addActionHandler('toggleStoryStatistics', (global, actions, payload) => {
...
addActionHandler('toggleLeftColumn', (global, actions, payload) => {
    const { tabId = getCurrentTabId() } = payload || {};
    return updateTabState(global, {
        isLeftColumnShown: !selectTabState(global, tabId).isLeftColumnShown,
    }, tabId);
});
addActionHandler('addRecentEmoji', (global, actions, payload) => {
    const { emoji } = payload;
...
addActionHandler('addRecentSticker', (global, actions, payload) => {
...
addActionHandler('addRecentCustomEmoji', (global, actions, payload) => {
...
addActionHandler('reorderStickerSets', (global, actions, payload) => {
...
addActionHandler('showAllowedMessageTypesNotification', (global, actions, payload) => {
    ...
    const { canSendPlainText, canSendPhotos, canSendVideos, canSendDocuments, canSendAudios, canSendStickers, canSendRoundVideos, canSendVoices, } = getAllowedAttachmentOptions(chat, chatFullInfo, isChatWithBot, isSavedMessages);
...
addActionHandler('dismissDialog', (global, actions, payload) => {
    const { tabId = getCurrentTabId() } = payload || {};
    const newDialogs = [...selectTabState(global, tabId).dialogs];
    newDialogs.pop();
    return updateTabState(global, {
...
addActionHandler('closeHistoryCalendar', (global, actions, payload) => {
    const { tabId = getCurrentTabId() } = payload || {};
    return updateTabState(global, {
...
addActionHandler('closeGame', (global, actions, payload) => {
    const { tabId = getCurrentTabId() } = payload || {};
    return updateTabState(global, {
...
addActionHandler('requestConfetti', (global, actions, payload) => {
    ...
    if (!selectCanAnimateInterface(global))
        return undefined;
    return updateTabState(global, {
        confetti: {
...
addActionHandler('requestWave', (global, actions, payload) => {
...
addActionHandler('requestEffectInComposer', (global, actions, payload) => {
    const { tabId = getCurrentTabId() } = payload;
    return updateTabState(global, {
        shouldPlayEffectInComposer: true,
    }, tabId);
});
addActionHandler('hideEffectInComposer', (global, actions, payload) => {
    const { tabId = getCurrentTabId() } = payload;
    return updateTabState(global, {
        shouldPlayEffectInComposer: undefined,
    }, tabId);
});
addActionHandler('setPaidMessageAutoApprove', (global) => {
    global = {
        ...global,
        settings: {
            ...global.settings,
...
addActionHandler('setReactionEffect', (global, actions, payload) => {
...
addActionHandler('closeLimitReachedModal', (global, actions, payload) => {
    const { tabId = getCurrentTabId() } = payload || {};
    return updateTabState(global, {
        limitReachedModal: undefined,
    }, tabId);
});
addActionHandler('closeStickerSetModal', (global, actions, payload) => {
    const { tabId = getCurrentTabId() } = payload || {};
    return updateTabState(global, {
...
addActionHandler('closeCustomEmojiSets', (global, actions, payload) => {
    const { tabId = getCurrentTabId() } = payload || {};
    return updateTabState(global, {
...
addActionHandler('closeCreateTopicPanel', (global, actions, payload) => {
    const { tabId = getCurrentTabId() } = payload || {};
    return updateTabState(global, {
...
addActionHandler('closeEditTopicPanel', (global, actions, payload) => {
    const { tabId = getCurrentTabId() } = payload || {};
    return updateTabState(global, {
        editTopicPanel: undefined,
    }, tabId);
});
addActionHandler('updateArchiveSettings', (global, actions, payload) => {
...
addActionHandler('openMapModal', (global, actions, payload) => {
...
addActionHandler('closeMapModal', (global, actions, payload) => {
    const { tabId = getCurrentTabId() } = payload || {};
    return updateTabState(global, {
        mapModal: undefined,
    }, tabId);
...
addActionHandler('setIsElectronUpdateAvailable', (global, action, payload) => {
    global = getGlobal();
    global = {
        ...global,
...
addActionHandler('afterHangUp', (global) => {
    if (!selectTabState(global, getCurrentTabId()).multitabNextAction)
        return;
    reestablishMasterToSelf();
});
let notificationInterval;
const NOTIFICATION_INTERVAL = 500;
addActionHandler('onTabFocusChange', (global, actions, payload) => {
...
addActionHandler('updatePageTitle', (global, actions, payload) => {
    const { tabId = getCurrentTabId() } = payload || {};
...
addActionHandler('closeInviteViaLinkModal', (global, actions, payload) => {
    const { tabId = getCurrentTabId() } = payload ?? {};
    return updateTabState(global, {
        inviteViaLinkModal: undefined,
    }, tabId);
});
addActionHandler('closeCollectibleInfoModal', (global, actions, payload) => {
    const { tabId = getCurrentTabId() } = payload ?? {};
    return updateTabState(global, {
        collectibleInfoModal: undefined,
    }, tabId);
});
addActionHandler('setShouldCloseRightColumn', (global, actions, payload) => {
    const { value, tabId = getCurrentTabId() } = payload;
    return updateTabState(global, {
        shouldCloseRightColumn: value,
    }, tabId);
});
addActionHandler('refreshLangPackFromCache', (global, actions, payload) => {
    refreshFromCache(payload.langCode);
});
addActionHandler('processPremiumFloodWait', (global, actions, payload) => {
    const { isUpload } = payload;
    const { bandwidthPremiumDownloadSpeedup, bandwidthPremiumUploadSpeedup, bandwidthPremiumNotifyPeriod, } = global.appConfig || {};
    ...
    if (lastNotifiedAt && Date.now() < lastNotifiedAt + bandwidthPremiumNotifyPeriod * 1000)
        return undefined;
    ...
    unblurredTabIds.forEach((tabId) => {
        actions.showNotification({
            ...
            message: langProvider.oldTranslate(isUpload ? 'UploadSpeedLimitedMessage' : 'DownloadSpeedLimitedMessage', isUpload ? bandwidthPremiumUploadSpeedup : bandwidthPremiumDownloadSpeedup),
