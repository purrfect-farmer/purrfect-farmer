...
import { clearPayment, updatePayment, updateStarsPayment, } from '../../reducers';
import { updateTabState } from '../../reducers/tabs';
import { selectTabState } from '../../selectors';
addActionHandler('closePaymentModal', (global, actions, payload) => {
...
addActionHandler('resetPaymentStatus', (global, actions, payload) => {
    const { tabId = getCurrentTabId() } = payload || {};
...
addActionHandler('closeGiveawayModal', (global, actions, payload) => {
    const { tabId = getCurrentTabId() } = payload || {};
    return updateTabState(global, {
        giveawayModal: undefined,
    }, tabId);
});
addActionHandler('closeGiftCodeModal', (global, actions, payload) => {
    const { tabId = getCurrentTabId() } = payload || {};
    return updateTabState(global, {
        giftCodeModal: undefined,
    }, tabId);
});
addActionHandler('updateGiftProfileFilter', (global, actions, payload) => {
...
addActionHandler('resetGiftProfileFilter', (global, actions, payload) => {
...
addActionHandler('openPaymentMessageConfirmDialogOpen', (global, actions, payload) => {
    const { tabId = getCurrentTabId() } = payload || {};
    return updateTabState(global, {
        isPaymentMessageConfirmDialogOpen: true,
    }, tabId);
});
addActionHandler('closePaymentMessageConfirmDialogOpen', (global, actions, payload) => {
    const { tabId = getCurrentTabId() } = payload || {};
    return updateTabState(global, {
