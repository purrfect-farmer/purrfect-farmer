...
import { addWebAppToOpenList, clearOpenedWebApps, hasOpenedMoreThanOneWebApps, hasOpenedWebApps, removeActiveWebAppFromOpenList, removeWebAppFromOpenList, replaceIsWebAppModalOpen, replaceWebAppModalState, updateWebApp, } from '../../reducers/bots';
import { updateTabState } from '../../reducers/tabs';
import { selectActiveWebApp, selectCurrentMessageList, selectTabState, selectWebApp, } from '../../selectors';
import { selectSharedSettings } from '../../selectors/sharedState';
addActionHandler('openWebAppTab', (global, actions, payload) => {
...
addActionHandler('updateWebApp', (global, actions, payload) => {
    const { key, update, tabId = getCurrentTabId(), } = payload;
    return updateWebApp(global, key, update, tabId);
});
addActionHandler('closeActiveWebApp', (global, actions, payload) => {
...
addActionHandler('openMoreAppsTab', (global, actions, payload) => {
    const { tabId = getCurrentTabId() } = payload || {};
...
addActionHandler('closeMoreAppsTab', (global, actions, payload) => {
    const { tabId = getCurrentTabId() } = payload || {};
    const tabState = selectTabState(global, tabId);
...
addActionHandler('closeWebApp', (global, actions, payload) => {
...
addActionHandler('closeWebAppModal', (global, actions, payload) => {
...
addActionHandler('changeWebAppModalState', (global, actions, payload) => {
    const { state, tabId = getCurrentTabId() } = payload;
    return replaceWebAppModalState(global, state, tabId);
});
addActionHandler('updateMiniAppCachedPosition', (global, actions, payload) => {
...
addActionHandler('updateMiniAppCachedSize', (global, actions, payload) => {
    const { size } = payload;
    global = updateSharedSettings(global, {
...
addActionHandler('cancelBotTrustRequest', (global, actions, payload) => {
    const { tabId = getCurrentTabId() } = payload || {};
...
addActionHandler('sendWebAppEvent', (global, actions, payload) => {
...
addActionHandler('cancelAttachBotInstall', (global, actions, payload) => {
    const { tabId = getCurrentTabId() } = payload || {};
    return updateTabState(global, {
...
addActionHandler('cancelAttachBotInChat', (global, actions, payload) => {
    const { tabId = getCurrentTabId() } = payload || {};
    return updateTabState(global, {
        requestedAttachBotInChat: undefined,
    }, tabId);
});
addActionHandler('openEmojiStatusAccessModal', (global, actions, payload) => {
...
addActionHandler('closeEmojiStatusAccessModal', (global, actions, payload) => {
    const { tabId = getCurrentTabId() } = payload || {};
    return updateTabState(global, {
        emojiStatusAccessModal: undefined,
    }, tabId);
});
addActionHandler('openLocationAccessModal', (global, actions, payload) => {
    const { bot, webAppKey, tabId = getCurrentTabId(), } = payload;
    if (!bot || !webAppKey)
        return;
    global = getGlobal();
...
addActionHandler('closeLocationAccessModal', (global, actions, payload) => {
    const { tabId = getCurrentTabId() } = payload || {};
    return updateTabState(global, {
