...
import { selectChatMessage, selectIsCurrentUserFrozen, selectStarsPayment, selectTabState, } from '../../selectors';
addActionHandler('processOriginStarsPayment', (global, actions, payload) => {
    const { originData, status, tabId = getCurrentTabId() } = payload;
    const { originStarsPayment, originReaction, originGift, topup, } = originData || {};
...
addActionHandler('openGiftRecipientPicker', (global, actions, payload) => {
...
addActionHandler('openStarsGiftingPickerModal', (global, actions, payload) => {
    const { tabId = getCurrentTabId(), } = payload || {};
    return updateTabState(global, {
...
addActionHandler('openPrizeStarsTransactionFromGiveaway', (global, actions, payload) => {
...
addActionHandler('openStarsBalanceModal', (global, actions, payload) => {
    const { originStarsPayment, originReaction, originGift, topup, shouldIgnoreBalance, tabId = getCurrentTabId(), } = payload || {};
...
addActionHandler('closeStarsPaymentModal', (global, actions, payload) => {
    const { tabId = getCurrentTabId() } = payload || {};
...
addActionHandler('openStarsTransactionModal', (global, actions, payload) => {
    const { transaction, tabId = getCurrentTabId() } = payload;
    return openStarsTransactionModal(global, transaction, tabId);
});
addActionHandler('openStarsTransactionFromGift', (global, actions, payload) => {
    const { chatId, messageId, tabId = getCurrentTabId(), } = payload || {};
    const message = selectChatMessage(global, chatId, messageId);
    if (!message)
        return undefined;
...
addActionHandler('openStarsSubscriptionModal', (global, actions, payload) => {
...
addActionHandler('closeStarsGiftModal', (global, actions, payload) => {
    const { tabId = getCurrentTabId() } = payload || {};
    return updateTabState(global, {
        starsGiftModal: { isOpen: false },
    }, tabId);
});
addActionHandler('openGiftInfoModalFromMessage', (global, actions, payload) => {
    const { chatId, messageId, tabId = getCurrentTabId(), } = payload;
    const message = selectChatMessage(global, chatId, messageId);
    if (!message || !message.content.action)
        return;
    const action = message.content.action;
    if (action.type !== 'starGift' && action.type !== 'starGiftUnique')
        return;
...
addActionHandler('openGiftInfoModal', (global, actions, payload) => {
...
addActionHandler('openGiftResalePriceComposerModal', (global, actions, payload) => {
...
addActionHandler('openGiftWithdrawModal', (global, actions, payload) => {
    const { gift, tabId = getCurrentTabId() } = payload || {};
    return updateTabState(global, {
        giftWithdrawModal: {
            gift,
...
addActionHandler('openGiftStatusInfoModal', (global, actions, payload) => {
...
addActionHandler('closeGiftStatusInfoModal', (global, actions, payload) => {
    const { tabId = getCurrentTabId() } = payload || {};
    return updateTabState(global, {
        giftStatusInfoModal: undefined,
    }, tabId);
});
addActionHandler('clearGiftWithdrawError', (global, actions, payload) => {
    const { tabId = getCurrentTabId() } = payload || {};
...
addActionHandler('openGiftTransferModal', (global, actions, payload) => {
    const { gift, tabId = getCurrentTabId() } = payload;
    return updateTabState(global, {
        giftTransferModal: {
            gift,
