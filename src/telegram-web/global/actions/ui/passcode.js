...
import { clearEncryptedSession, encryptSession, forgetPasscode, setupPasscode, } from '../../../util/passcode';
...
addActionHandler('setPasscode', async (global, actions, payload) => {
...
addActionHandler('unlockScreen', (global, actions, payload) => {
