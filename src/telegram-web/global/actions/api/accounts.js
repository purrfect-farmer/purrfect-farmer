...
addActionHandler('reportPeer', async (global, actions, payload) => {
    const { chatId, reason, description, tabId = getCurrentTabId(), } = payload;
    if (!chatId) {
        return;
    }
...
addActionHandler('reportProfilePhoto', async (global, actions, payload) => {
    const { chatId, reason, description, photo, tabId = getCurrentTabId(), } = payload;
    if (!chatId) {
        return;
    }
    const chat = selectChat(global, chatId);
...
addActionHandler('loadAuthorizations', async (global) => {
...
addActionHandler('changeSessionSettings', async (global, actions, payload) => {
    const { hash, areCallsEnabled, areSecretChatsEnabled, isConfirmed, } = payload;
...
addActionHandler('loadAccountDaysTtl', async (global, actions, payload) => {
...
addActionHandler('setAccountTTL', async (global, actions, payload) => {
