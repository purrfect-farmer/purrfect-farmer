...
import { isStreamEnabled, joinGroupCall, leaveGroupCall, setVolume, startSharingScreen, stopPhoneCall, toggleStream, } from '../../../lib/secret-sauce';
import { getCurrentTabId } from '../../../util/establishMultitabRole';
import { callApi } from '../../../api/gramjs';
import { addActionHandler, getGlobal, setGlobal } from '../../index';
import { removeGroupCall, updateActiveGroupCall, } from '../../reducers/calls';
import { updateTabState } from '../../reducers/tabs';
import { selectChat, selectTabState, selectUser } from '../../selectors';
import { selectActiveGroupCall, selectPhoneCallUser, } from '../../selectors/calls';
...
addActionHandler('leaveGroupCall', async (global, actions, payload) => {
    const { isFromLibrary, shouldDiscard, shouldRemove, rejoin, isPageUnload, tabId = getCurrentTabId(), } = payload || {};
...
addActionHandler('connectToActiveGroupCall', async (global, actions, payload) => {
...
addActionHandler('closeCallRatingModal', (global, actions, payload) => {
    const { tabId = getCurrentTabId() } = payload || {};
...
addActionHandler('hangUp', (global, actions, payload) => {
