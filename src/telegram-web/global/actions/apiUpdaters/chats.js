...
import { addChatListIds, addUnreadMentions, deleteChatMessages, deletePeerPhoto, leaveChat, removeUnreadMentions, replacePeerPhotos, replacePinnedTopicIds, replaceThreadParam, updateChat, updateChatFullInfo, updateChatListType, updatePeerStoriesHidden, updateTopic, } from '../../reducers';
import { updateUnreadReactions } from '../../reducers/reactions';
import { updateTabState } from '../../reducers/tabs';
import { selectChat, selectChatFullInfo, selectChatListType, selectChatMessages, selectCommonBoxChatId, selectCurrentMessageList, selectIsChatListed, selectPeer, selectTabState, selectThreadParam, selectTopicFromMessage, } from '../../selectors';
const TYPING_STATUS_CLEAR_DELAY = 6000; // 6 seconds
const INVALIDATE_FULL_CHAT_FIELDS = new Set([
    ...
    switch (update['@type']) {
        case 'updateChat': {
            ...
            if (localChat) {
                ...
                const changedFields = Object.keys(chatUpdate)
        ...
        case 'draftMessage': {
            const { chatId, threadId, draft, } = update;
