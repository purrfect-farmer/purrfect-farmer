import { handleUpdateGroupCallConnection, handleUpdateGroupCallParticipants, joinPhoneCall, processSignalingMessage, } from '../../../lib/secret-sauce';
...
addActionHandler('apiUpdate', (global, actions, update) => {
    ...
    switch (update['@type']) {
        ...
        case 'updateGroupCallStreams': {
            if (!update.userId || !activeGroupCallId)
                break;
        ...
        case 'updatePhoneCall': {
            ...
            const { accessHash, state, connections, gB, } = call;
            ...
            if (state === 'discarded') {
                ...
                void joinPhoneCall(connections, actions.sendSignalingData, isOutgoing, Boolean(call?.isVideo), Boolean(call.isP2pAllowed), actions.apiUpdate);
            }
            return global;
        }
