...
export const APP_NAME =
  import.meta.env.VITE_TW_APP_NAME || `Telegram Web ${APP_CODE_NAME}`;
export const RELEASE_DATETIME = import.meta.env.VITE_TW_RELEASE_DATETIME;
...
export const BASE_URL = import.meta.env.VITE_TW_BASE_URL;
export const ACCOUNT_QUERY = "account";
export const IS_MOCKED_CLIENT =
  import.meta.env.VITE_TW_APP_MOCKED_CLIENT === "1";
export const IS_TEST = import.meta.env.VITE_TW_APP_ENV === "test";
export const IS_PERF = import.meta.env.VITE_TW_APP_ENV === "perf";
export const IS_BETA = import.meta.env.VITE_TW_APP_ENV === "staging";
export const IS_PACKAGED_ELECTRON = import.meta.env
  .VITE_TW_IS_PACKAGED_ELECTRON;
...
export const ELECTRON_HOST_URL = import.meta.env.VITE_TW_ELECTRON_HOST_URL;
export const DEBUG_ALERT_MSG =
  "Shoot!\nSomething went wrong, please see the error details in Dev Tools Console.";
export const DEBUG_GRAMJS = false;
export const ENABLE_WEB_SYNC = false;
export const PAGE_TITLE = import.meta.env.VITE_TW_APP_TITLE;
...
export const API_CHAT_TYPES = ["bots", "channels", "chats", "users", "groups"];
export const HEART_REACTION = {
  type: "emoji",
  emoticon: "❤",
};
// MTProto constants
...
export const PREMIUM_BOTTOM_VIDEOS = [
  "faster_download",
  "voice_to_text",
  "advanced_chat_management",
  "infinite_reactions",
...
export const PREMIUM_LIMITS_ORDER = [
  "channels",
  "dialogFolderPinned",
  "channelsPublic",
  "savedGifs",
...
export const DEFAULT_GIFT_PROFILE_FILTER_OPTIONS = {
  sortType: "byDate",
