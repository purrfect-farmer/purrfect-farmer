...
export default function useUnsupportedMedia(ref, shouldDisableNotification, isDisabled) {
    ...
    const onError = useLastCallback((event) => {
    ...
    const onCanPlay = useLastCallback((event) => {
        const target = event.currentTarget;
