import { getIsHeavyAnimating, useCallback, useEffect, useMemo, useRef, } from '../lib/teact/teact';
...
export default function useHeavyAnimation(onStart, onEnd, isDisabled = false) {
...
// TODO → `onFullyIdle`?
export function useThrottleForHeavyAnimation(afterHeavyAnimation, deps) {
