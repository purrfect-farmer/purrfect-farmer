...
const ActiveCallHeader = ({ groupCall, phoneCallUser, isCallPanelVisible, }) => {
    ...
    if (!groupCall && !phoneCallUser)
        return undefined;
    return (<div className={buildClassName('ActiveCallHeader', isCallPanelVisible && 'open')} onClick={handleToggleGroupCallPanel}>
