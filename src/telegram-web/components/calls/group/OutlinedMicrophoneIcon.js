...
const OutlinedMicrophoneIcon = ({ participant, noColor, className, }) => {
    ...
    return (<AnimatedIcon tgsUrl={LOCAL_TGS_URLS.VoiceOutlined} play={playSegment.toString()} playSegment={playSegment} size={28} color={microphoneColor} className={className} forceAlways nonInteractive/>);
};
