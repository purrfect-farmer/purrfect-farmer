...
const CodeOverlay = ({ text, className, noCopy, onWordWrapToggle, }) => {
    ...
    return (<div className={overlayClass} ref={ref}>
      <div className={contentClass}>
        {withWordWrapButton && (<div className={wrapClass} onClick={handleWordWrapClick} title="Word Wrap">
            <Icon name="word-wrap"/>
          </div>)}
        {!noCopy && (<div className={styles.copy} onClick={handleCopy} title={lang('Copy')}>
            <Icon name="copy"/>
          </div>)}
      </div>
    </div>);
