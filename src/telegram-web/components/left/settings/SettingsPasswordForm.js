...
const SettingsPasswordForm = ({ isActive, onReset, error, isLoading, shouldDisablePasswordManager, expectedPassword, placeholder = 'Current Password', hint, submitLabel, clearError, onSubmit, }) => {
