...
function RequirementToContactMessage({ patternColor, peer, paidMessagesStars, }) {
    ...
    return (<div className={styles.root}>
      <div className={styles.inner}>
        <div className={styles.iconsContainer}>
          <AnimatedIconWithPreview tgsUrl={LOCAL_TGS_URLS.Unlock} size={54} color={patternColor} className={styles.animatedUnlock}/>
        ...
        <span className={styles.description}>
          {paidMessagesStars
            ? lang(isApiPeerUser(peer) ? 'MessagesPlaceholderPaidUser' : 'MessagesPlaceholderPaidChannel', {
                ...
                amount: formatStarsAsIcon(lang, paidMessagesStars, {
                    asFont: true,
        ...
        <Button color="translucent-black" size="default" pill onClick={paidMessagesStars ? handleGetMoreStars : handleOpenPremiumModal} className={styles.button}>
          {paidMessagesStars
            ? (<>
                  {lang('ButtonBuyStars')}
...
export default memo(withGlobal((global, { peerId: userId }) => {
