...
export default function useDetectChatLanguage(message, detectedLanguage, isDisabled, getIsReady) {
    useEffect(() => {
...
function processMessageMetadata({ chatId, id, isTranslatable, detectedLanguage, }) {
    const chatStats = CHAT_STATS.get(chatId) || new LimitedMap(MESSAGES_LIMIT);
