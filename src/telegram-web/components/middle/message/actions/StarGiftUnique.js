...
const StarGiftAction = ({ action, message, canPlayAnimatedEmojis, sender, recipient, onClick, observeIntersectionForLoading, observeIntersectionForPlaying, }) => {
    ...
    return (<div className={buildClassName(styles.contentBox, styles.starGift, styles.uniqueGift)} tabIndex={0} role="button" onClick={onClick}>
      <div className={styles.uniqueBackgroundWrapper}>
        <RadialPatternBackground className={styles.uniqueBackground} backgroundColors={backgroundColors} patternColor={backdrop.patternColor} patternIcon={pattern.sticker} clearBottomSector/>
      </div>
      ...
      <GiftRibbon color={adaptedPatternColor} text={lang('ActionStarGiftUniqueRibbon')}/>
      ...
      <div className={styles.actionButton} style={buildStyle(adaptedPatternColor && `background-color: ${adaptedPatternColor}`)}>
