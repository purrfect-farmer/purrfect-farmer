import { calculateExtendedPreviewDimensions, calculateInlineImageDimensions, calculateVideoDimensions, REM, } from '../../../common/helpers/mediaDimensions';
const SMALL_IMAGE_THRESHOLD = 12;
const MIN_MESSAGE_LENGTH_FOR_BLUR = 40;
export const MIN_MEDIA_WIDTH_WITH_TEXT = 20 * REM;
const MIN_MEDIA_WIDTH = SMALL_IMAGE_THRESHOLD * REM;
export const MIN_MEDIA_HEIGHT = 5 * REM;
export function getMinMediaWidth(text, hasCommentButton) {
    return (text?.length ?? 0) > MIN_MESSAGE_LENGTH_FOR_BLUR || hasCommentButton
        ? MIN_MEDIA_WIDTH_WITH_TEXT
        : MIN_MEDIA_WIDTH;
}
export function calculateMediaDimensions({ media, messageText, isOwn, isInWebPage, asForwarded, noAvatars, isMobile, }) {
