...
const NoMessages = ({ isChatWithSelf, type, isGroupChatJustCreated, topic, }) => {
    ...
    return (<div className="empty"><span>{lang('NoMessages')}</span></div>);
};
...
function renderScheduled(lang) {
    return (<div className="empty"><span>{lang('ScheduledMessages.EmptyPlaceholder')}</span></div>);
}
