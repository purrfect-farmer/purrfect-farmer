...
const MiddleSearchResult = ({ isActive, message, senderPeer, messageChat, shouldShowChat, query, className, onClick, }) => {
    ...
    return (<div role="button" tabIndex={0} className={buildClassName(styles.root, isActive && styles.active, className)} onClick={handleClick}>
      <Avatar className={styles.avatar} peer={peer} text={hiddenForwardTitle} size="medium"/>
