...
export var DropAreaState;
(function (DropAreaState) {
    DropAreaState["None"] = "none";
    DropAreaState["Document"] = "document";
    DropAreaState["QuickFile"] = "quick_file";
})(DropAreaState || (DropAreaState = {}));
const DROP_LEAVE_TIMEOUT_MS = 150;
const DropArea = ({ isOpen, withQuick, onHide, onFileSelect, editingMessage, }) => {
    const lang = useLang();
    ...
    const handleQuickFilesDrop = useLastCallback(async (e) => {
        const { dataTransfer: dt } = e;
    ...
    const className = buildClassName('DropArea', transitionClassNames);
    return (<Portal containerSelector="#middle-column-portals">
      <div className={className} onDragLeave={handleDragLeave} onDragOver={handleDragOver} onDrop={onHide} onClick={onHide}>
