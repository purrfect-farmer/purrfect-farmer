...
import { EDITABLE_INPUT_ID, EDITABLE_INPUT_MODAL_ID, EDITABLE_STORY_INPUT_ID, } from '../../../../config';
...
const useClipboardPaste = (isActive, insertTextAndUpdateCursor, setAttachments, setNextText, editedMessage, shouldStripCustomEmoji, onCustomEmojiStripped) => {
    ...
    useEffect(() => {
        ...
        async function handlePaste(e) {
            ...
            let pastedFormattedText = html ? parseHtmlAsFormattedText(preparePastedHtml(html), undefined, true) : undefined;
