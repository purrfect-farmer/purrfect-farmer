...
const THROTTLE = 300;
export default function useChatCommandTooltip(isEnabled, getHtml, botCommands, chatBotCommands, quickReplies) {
    ...
    const getCommand = useDerivedSignal(detectCommandThrottled, [detectCommandThrottled, getHtml], true);
    useEffect(() => {
