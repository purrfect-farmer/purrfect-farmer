import { MIN_SCREEN_WIDTH_FOR_STATIC_LEFT_COLUMN, MIN_SCREEN_WIDTH_FOR_STATIC_RIGHT_COLUMN, MOBILE_SCREEN_MAX_WIDTH, } from '../../../config';
...
export default function calculateMiddleFooterTransforms(windowWidth, canPost) {
