...
const RoundTimer = ({ duration, className, onEnd }) => {
    ...
    return (<div className={buildClassName(styles.root, className)}>
      <svg className={styles.svg} width="32px" height="32px">
        <circle cx="16" cy="16" r={TIMER_RADIUS} transform="rotate(-90, 16, 16)" pathLength="100" stroke-dasharray="100" stroke-dashoffset={100 - ((timeLeft - 1) / duration) * 100} // Show it one step further due to animation
