...
const ProgressSpinner = ({ progress = 0, size = 'l', square, transparent, noCross, rotationOffset, withColor, onClick, }) => {
    ...
    const className = buildClassName(`ProgressSpinner size-${size}`, transparent && 'transparent', square && 'square', noCross && 'no-cross');
