...
function StatisticsMessagePublicForward({ data, chatsById, usersById }) {
    ...
    return (<div className={buildClassName(styles.root, 'statistic-public-forward')} onClick={handleClick}>
