...
const StatisticsOverview = ({ title, type, statistics, isToncoin, className, subtitle, }) => {
    ...
    const renderOverviewItemValue = ({ change, percentage }) => {
        ...
        return (<span className={buildClassName(styles.value, isChangeNegative && styles.negative)}>
        {isChangeNegative
    ...
    const { balances, usdRate } = statistics;
    ...
    return (<div className={buildClassName(styles.root, className)}>
      <div className={styles.header}>
        ...
        {period && (<div className={styles.caption}>
      ...
      <table className={styles.table}>
        {isToncoin ? (<tr>
          ...
          </tr>) : schema.map((row) => (<tr>
            {row.map((cell) => {
                const field = statistics[cell.name];
                if (cell.isPlain) {
                    return (<td className={styles.tableCell}>
                    <b className={styles.tableValue}>
                ...
                if (cell.isPercentage) {
                    return (<td className={styles.tableCell}>
                    {cell.withAbsoluteValue && (<span className={styles.tableValue}>
