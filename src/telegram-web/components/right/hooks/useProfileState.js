...
export default function useProfileState(containerRef, tabType, profileState, onProfileStateChange, forceScrollProfileTab = false, allowAutoScrollToTabs = false, handleStopAutoScrollToTabs) {
    ...
    const determineProfileState = useLastCallback(() => {
        ...
        let state = ProfileState.Profile;
