...
export function calculateSlideSizes(windowWidth, windowHeight) {
...
export function calculateOffsetX({ scale, slideAmount, isActiveSlideSize, isMoveThroughActiveSlide, isBackward, }) {
