...
const ChatlistDelete = ({ folder, suggestedPeerIds = MEMO_EMPTY_ARRAY, }) => {
    ...
    return (<div className={styles.content}>
      {Boolean(suggestedPeerIds?.length) && (<>
          ...
          <div className={buildClassName(styles.pickerWrapper, 'custom-scroll')}>
            ...
            <PeerPicker itemIds={suggestedPeerIds} onSelectedIdsChange={setSelectedPeerIds} selectedIds={selectedPeerIds} allowMultiple withStatus itemInputType="checkbox"/>
          </div>
        </>)}
