...
const OpenMapModal = ({ modal }) => {
    ...
    const openUrl = useLastCallback((url) => {
        closeMapModal();
    ...
    return (<Modal contentClassName={styles.root} title={lang('OpenMapWith')} isOpen={isOpen} onClose={handleClose} isSlim>
      <div className={styles.buttons}>
        {(IS_IOS || IS_MAC_OS) && (<Button fluid size="smaller" onClick={handleAppleClick}>
            Apple Maps
          </Button>)}
