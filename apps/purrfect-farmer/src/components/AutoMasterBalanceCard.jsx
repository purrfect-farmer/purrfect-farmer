...
import AutoMasterEditDialog from "./AutoMasterEditDialog";
...
export function AutoMasterBalanceCard() {
  const { config, master, enableRequests, setEnableRequests } = useAuto();
  ...
  return (
    ...
    >
      ...
      <Dialog.Root open={editOpen} onOpenChange={setEditOpen}>
        ...
        <AutoMasterEditDialog onSave={() => setEditOpen(false)} />
      </Dialog.Root>
      ...
      >
        <MdOutlineContentCopy /> <AutoAddress address={master?.address} />
      </button>
      <AutoVersionBadge version={master?.version} />
    </div>
  );
}
